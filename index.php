      ...
      <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <div class="col-4 text-center">
            <a class="blog-header-logo text-dark" href="#">Unstrapped</a>
          </div>
      ...
      <div class="row">
        <div class="col-md-8 blog-main">
          ...
          <div class="blog-post">
            ...
            <p class="blog-post-meta">January 1, 2019 by <a href="#">Htmlcenter</a></p>
          ...
          <div class="blog-post">
            ...
            <p class="blog-post-meta">December 23, 2018 by <a href="#">Popularowl</a></p>
